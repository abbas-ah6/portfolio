...
type BlogDocumentDataSlicesSlice = BlogsSlice | RichTextSlice;
...
/**
 * Item in *Bento → Default → Primary → Bento Card*
 */
export interface BentoSliceDefaultPrimaryBentoCardItem {
  /**
   * title field in *Bento → Default → Primary → Bento Card*
   *
   * - **Field Type**: Title
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.bento_card[].title
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  title: prismic.TitleField;

  /**
   * body field in *Bento → Default → Primary → Bento Card*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.bento_card[].body
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  body: prismic.RichTextField;

  /**
   * image field in *Bento → Default → Primary → Bento Card*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.bento_card[].image
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  image: prismic.ImageField<never>;

  /**
   * Wide field in *Bento → Default → Primary → Bento Card*
   *
   * - **Field Type**: Boolean
   * - **Placeholder**: *None*
   * - **Default Value**: false
   * - **API ID Path**: bento.default.primary.bento_card[].wide
   * - **Documentation**: https://prismic.io/docs/field#boolean
   */
...
export interface BentoSliceDefaultPrimary {
  ...
  /**
   * Bento Card field in *Bento → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.bento_card[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  bento_card: prismic.GroupField<
    Simplify<BentoSliceDefaultPrimaryBentoCardItem>
  >;
}
...
export interface BlogsSliceDefaultPrimaryBlogsItem {
  /**
   * Blogs List field in *Blogs → Default → Primary → Blogs*
   *
   * - **Field Type**: Content Relationship
   * - **Placeholder**: *None*
   * - **API ID Path**: blogs.default.primary.blogs[].blogs_list
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  blogs_list: prismic.ContentRelationshipField<"blog">;
}
...
export interface IntegrationsSliceDefaultPrimaryIconsItem {
  ...
  icon: prismic.SelectField<
    "cloudflare" | "npm" | "github" | "digitalocean" | "figma" | "fly"
  >;
}
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      AllDocumentTypes,
      BentoSlice,
      BentoSliceDefaultPrimaryBentoCardItem,
